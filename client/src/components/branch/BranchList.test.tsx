...
describe('BranchList component', () => {
    it('calls the query method on Apollo Client', () => {
        const wrapper = mount(
            customWrapper( <BranchList />,  [], RoutePaths.Branches, RoutePaths.Branches)
        );
    ...
    it('renders without crashing', async () => {
        const wrapper = mount(customWrapper( <BranchList />, getBranchesMock, RoutePaths.Branches, RoutePaths.Branches));
